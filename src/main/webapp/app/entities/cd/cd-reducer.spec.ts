...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CD actions', async () => {
      const expectedActions = [
        {
