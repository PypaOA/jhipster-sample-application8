...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dvd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DVD_LIST actions', async () => {
    ...
    it('dispatches FETCH_DVD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DVD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DVD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DVD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DVD actions', async () => {
      const expectedActions = [
        {
